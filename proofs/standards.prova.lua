--- The p6m platform standards, held against the golang BASIC service archetype.
---
...
--- network. Docker is the single requirement — no Go toolchain on the host, so this suite behaves
...
prova.group("golang-basic: the archetype itself", function(g)
